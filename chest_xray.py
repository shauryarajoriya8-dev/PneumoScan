...
class Ui_MainWindow(object):
    ...
    def predict_result(self):
        ...
        model = load_model('E:\s\projects\pneumoscan\ML_Proj\chest_xray_.h5') 
    ...
    def download_report(self):
        ...
        if report_path:
            ...
            # Cover Page
            hospital_logo = "E:\s\projects\pneumoscan\ML_Proj\\logo.jpg"
            ...
            if result[0][0] < 0.5:
                ...
                Please <a href="/">click here</a> to book an appointment with a doctor.
                """
